...
# NUCLEAR FIX: Force this specific folder to be Priority #1
current_dir = os.path.dirname(os.path.abspath(__file__))
sys.path.insert(0, current_dir)


# DEBUG: Print exactly where Python is looking first
print(f"🚀 PRIORITY PATH SET TO: {sys.path[0]}")
...
def main():
    ...
    for epoch in range(start_epoch, p['epochs']):
        ...
        if epoch % 50 == 0 or epoch == p['epochs'] - 1:
            # Fill memory bank
